module "voice" {
  ...
  target_tracking_target_value           = 65
  target_tracking_predefined_metric_name = "ECSServiceAverageCPUUtilization"
  target_tracking_scale_in_cooldown      = 60
  ...
  host_header_values = ["alpha-agent-leasing-voice.knocktest.com"]
