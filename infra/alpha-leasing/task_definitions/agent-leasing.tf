    ...
    containerDefinitions = [
      {
        ...
        image             = "171267611104.dkr.ecr.us-east-1.amazonaws.com/nginx-proxy:proxy-pass-websocket"   # TODO: return this back to the original image (if possible)
        memory            = 256
      ...
      {
        name              = "mock-server"
        image             = "171267611104.dkr.ecr.us-east-1.amazonaws.com/agent-leasing:mockserver-${var.app_image_tag}"
        cpu               = 128
        memory            = 512
